...
<li><a href="#"><i class="fa fa-files-o"></i> Manufacturers</a>
<ul>
<li><a href="create-brand.php">Add Manufacturers</a></li>
<li><a href="manage-brands.php">Manage Manufacturers</a></li>
</ul>
</li>
...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
				...
				<li><a href="manage-contactusquery.php"><i class="fa fa-desktop"></i> Manage Contact Us Queries</a></li>
				<li><a href="reg-users.php"><i class="fa fa-users"></i> List of Registered Users</a></li>
