...
echo "<script>window.location.href = 'payment.php?vhid=" . htmlentities($vhid) . "';</script>";
exit;
}
else 
{
...
<title>Weissach Rentals | Vehicle Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p style="color: #ffea17;">₹<?php echo htmlentities($result->PricePerDay);?> </p>Per Day
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab" style="color:darkgrey;">Vehicle Overview </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab" style="color:darkgrey;">Accessories</a></li>
            </ul>
...
<?php }} ?>
    ...
    <div class="sidebar_widget">
        ...
        <form id="bookingForm" method="post" onsubmit="return validateDates()">
            <div class="form-group">
                <label for="fromdate" style="color:lightgrey">Pick Up Date | </label>
                <input type="date" id="fromdate" name="fromdate" required>
            </div>
            <div class="form-group">
                <label for="todate" style="color:lightgrey">Drop off Date | </label>
                <input type="date" id="todate" name="todate" required>
            </div>
            <div class="form-group">
                <label for="DL Number" style="color:lightgrey">Enter your Driving License Number</label>
                <textarea rows="1" class="form-control" name="message" placeholder="eg: KL582021XXXX" required></textarea>
            </div>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price" style="color:#6488EA">₹<?php echo htmlentities($result->PricePerDay);?></p>
          
              <ul class="features_list" style="background-color:#252525">
...
<script>
    function validateDates() {
        ...
        // Convert to UTC to ensure consistent comparison across timezones
        fromDate.setUTCHours(0, 0, 0, 0);
        toDate.setUTCHours(0, 0, 0, 0);

        if (toDate < fromDate) {
            alert('Please ensure that the return date is later than the pickup date.');
