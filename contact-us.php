...
<title>Weissach Rentals | Contact Us</title>
<!--Bootstrap -->
...
<!--Contact-us-->
<section class="contact_us section-padding" style="background-color: #252525">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3 style="color:#ffea17">Get in touch using the form below</h3>
      ...
      <div class="col-md-6">
        <h3 style="color:#ffea17">Contact Info</h3>
        <div class="contact_detail">
          <h5> <span>Address: </span>North Kalamassery, Ernakulam, Kerala, India 683104 <br> <br>
          <span>Email: </span>contactus@weissachrentals.com <br> <br>
            <span>Mobile: </span>+91 6969696969</h5>
              <?php 
$pagetype=$_GET['type'];
