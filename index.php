      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Experience the thrill of 7000 rpm</h1>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2 style:""><span>Seek Out Your</span> Adrenaline Boost</h2>
      <p>Unleash the thrill of the open road with our range of high-performance cars, where every drive is an exhilarating experience. From sleek sports cars to powerful supercars, 
        we offer top-tier performance vehicles to elevate your journey to the next level.</p>
    </div>
    <div class="row"> 
...
ORDER BY tblvehicles.RegDate DESC
LIMIT 3";
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>30+</h2>
            <p>Luxury Tourers</p>
          </div>
        </div>
      </div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Supercar Stories: <span>Feedback from Our Clients</span></h2>
    </div>
    <div class="row">
